...
generate_and_combine_audio(texts_telecom, "telecom_cozumlenmis.wav")
...
generate_and_combine_audio(texts_ecommerce, "ecommerce_cozumlenmis.wav")
...
generate_and_combine_audio(texts_health, "health_cozumlenmis.wav")
...
generate_and_combine_audio(texts_electronics, "electronics_cozumlenmis.wav")
...
generate_and_combine_audio(texts_banking, "banking_cozumlenmis.wav")
